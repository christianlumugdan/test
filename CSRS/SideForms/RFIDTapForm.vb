        ...
        If Len(TextBox1.Text) = 10 Then
            ...
            Else
                ...
                If SerialPort1.IsOpen Then
                    ...
                    SerialPort1.WriteLine("AT+CMGS=" & Chr(34) & Admin_AddCustomer.BunifuMetroTextbox3.Text & Chr(34) & vbCr)
                    System.Threading.Thread.Sleep(200)
                    SerialPort1.WriteLine("Welcome to Movieworld " + Admin_AddCustomer.BunifuMetroTextbox1.Text + "! Thank you for choosing Robinsons. Your current load is: " & Admin_AddCustomer.BunifuMetroTextbox5.Text & vbCrLf & Chr(26))
                    System.Threading.Thread.Sleep(200)
