...
Public Class Admin_deleteStaff
    ...
    Dim un As String
    Public staffdelete As Boolean = False
    Dim samp As Integer = 0

    Private Sub Admin_deleteStaff_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        Me.TopMost=True 
    End Sub
    ...
    Private Sub DeleteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DeleteToolStripMenuItem.Click
        un = ListView1.FocusedItem.SubItems.Item(6).Text
            Admin_passcode.Show()
            staffdelete = True
    End Sub
