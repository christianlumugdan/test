...
Public Class Admin_makePasscode
    ...
    Private Sub Admin_makePasscode_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        Me.TopMost = True
    End Sub
    ...
    Private Sub Passcode_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            comm = New SqlCommand("Select * from Admins where Username='" & Admin_addAdmin.user & "'", conn)
    ...
    Private Sub BunifuImageButton2_Click(sender As Object, e As EventArgs) Handles BunifuImageButton2.Click
        ...
        Else
            ...
            conn = New SqlConnection(constr)
            conn.Open()
            comm = New SqlCommand("Update Admins set Passcode='" & code & "' where Username='" & Admin_addAdmin.BunifuMetroTextbox4.Text & "'", conn)
