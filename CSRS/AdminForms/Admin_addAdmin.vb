...
Public Class Admin_addAdmin
    ...
    Dim admintype As String = "regular"
    ...
    Private Sub Admin_addAdmin_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        Me.TopMost = True
    End Sub
        ...
        If BunifuMetroTextbox4.Text <> "Username" Then
            ...
            Else
                If un = True Then
                    conn = New SqlConnection(constr)
                    conn.Open()
                    comm = New SqlCommand("Insert into Admins(Firstname, Lastname, Birthday, Contact, Email, Address, Username, Password, SecurityQ1, SecurityQ2, SecurityI1, SecurityI2, SecurityA1, SecurityA2, Type, PasscodeTime) values ('" & BunifuMetroTextbox1.Text & "','" & BunifuMetroTextbox2.Text & "','" & BunifuDatepicker1.Value & "','" & BunifuMetroTextbox3.Text & "','" & BunifuMetroTextbox8.Text & "','" & BunifuMetroTextbox9.Text & "','" & BunifuMetroTextbox4.Text & "','" & BunifuMetroTextbox5.Text & "','" & BunifuDropdown1.selectedValue & "','" & BunifuDropdown2.selectedValue & "','" & BunifuDropdown1.selectedIndex & "','" & BunifuDropdown2.selectedIndex & "','" & BunifuMetroTextbox6.Text & "','" & BunifuMetroTextbox7.Text & "','" & admintype & "','120')", conn)
                    affector = comm.ExecuteNonQuery
                    Admin_makePasscode.Show()
                End If
            End If
        End If
    End Sub
