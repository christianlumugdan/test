...
Public Class Admin_editStaff
    ...
    Public editstaff As Boolean = False
    Public confireditstaff As Boolean = False
    ...
    Private Sub Admin_addAdmin_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            comm = New SqlCommand("Select * from Staffs where Contact='" & Admin_viewStaff.id & "'", conn)
