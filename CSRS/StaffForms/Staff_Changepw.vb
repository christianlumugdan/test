...
Public Class Staff_Changepw
    ...
    Private Sub BunifuMaterialTextbox2_Enter(sender As Object, e As EventArgs) Handles BunifuMaterialTextbox2.Enter
        ...
        If BunifuMaterialTextbox1.Text = "" Then
            BunifuMaterialTextbox1.Text = "Type your old password"
    ...
    Private Sub BunifuMaterialTextbox1_Click(sender As Object, e As EventArgs) Handles BunifuMaterialTextbox1.Click
        If BunifuMaterialTextbox1.Text = "Type your old password" Then
    ...
    Private Sub BunifuMaterialTextbox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles BunifuMaterialTextbox1.KeyPress
        If Len(BunifuMaterialTextbox1.Text) = 30 Then
            If Not (Asc(e.KeyChar) = 8) Then
                Dim allowedChars As String = ""
                If Not allowedChars.Contains(e.KeyChar.ToString.ToLower) Then
                    e.KeyChar = ChrW(0)
            ...
            End If
        Else
            BunifuMaterialTextbox1.LineIdleColor = Color.Lime
        End If
        If Not (Asc(e.KeyChar) = 8) Then
            Dim allowedChars As String = "abcdefghijklmnopqrstuvwxyz1234567890"
            If Not allowedChars.Contains(e.KeyChar.ToString.ToLower) Then
    ...
    Private Sub BunifuThinButton21_Click(sender As Object, e As EventArgs) Handles BunifuThinButton21.Click
        BunifuCustomLabel1.Select()
        If BunifuMaterialTextbox1.LineIdleColor = Color.Gray Then
            BunifuMaterialTextbox1.LineIdleColor = Color.Red
        End If
        ...
        If BunifuMaterialTextbox1.Text <> "Type your old password" Then
            If BunifuMaterialTextbox1.Text = "" Then
                ...
                BunifuMaterialTextbox1.isPassword = False
            Else
                If BunifuMaterialTextbox1.Text <> Loginfrm.BunifuMaterialTextbox2.Text Then
                    BunifuMaterialTextbox1.LineIdleColor = Color.Red
                    Label2.Visible = True
                Else
                    Label2.Visible = False
        ...
        If BunifuMaterialTextbox2.Text <> "Type your new password" Then
            ...
            Else
                ...
                ElseIf BunifuMaterialTextbox2.Text = BunifuMaterialTextbox1.Text Then
                    Label3.Visible = True
                    Label3.Text = "Must not be the same with old password"
        ...
        End If
        If BunifuMaterialTextbox1.LineIdleColor = Color.Red Or BunifuMaterialTextbox2.LineIdleColor = Color.Red Or BunifuMaterialTextbox3.LineIdleColor = Color.Red Then
            If BunifuMaterialTextbox1.LineIdleColor = Color.Red Then
                BunifuMaterialTextbox1.Visible = False
                TextboxTransition.ShowSync(BunifuMaterialTextbox1)
            End If
        ...
        Else
            conn = New SqlConnection(constr)
            conn.Open()
            comm = New SqlCommand("Update Staffs set Password='" & BunifuMaterialTextbox2.Text & "' where Username='" & Loginfrm.BunifuMaterialTextbox1.Text & "'", conn)
    ...
    Private Sub BunifuImageButton4_MouseDown(sender As Object, e As MouseEventArgs) Handles BunifuImageButton4.MouseDown
        If BunifuMaterialTextbox1.Text <> "Type your old password" Then
            BunifuMaterialTextbox1.isPassword = False
        End If
    End Sub

    Private Sub BunifuImageButton4_MouseUp(sender As Object, e As MouseEventArgs) Handles BunifuImageButton4.MouseUp
        If BunifuMaterialTextbox1.Text <> "Type your old password" Then
            BunifuMaterialTextbox1.isPassword = True
        End If
    End Sub
