...
Public Class Staff_settings
    ...
    Private Sub Admin_settings_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        While reader.Read
            BunifuMetroTextbox1.Text = reader("PasscodeTimer") / 60
        End While
        conn.Close()
    ...
    Private Sub BunifuiOSSwitch1_OnValueChange(sender As Object, e As EventArgs) Handles BunifuiOSSwitch1.OnValueChange
        ...
        Else
            ...
            Else
                ...
                conn.Open()
                comm = New SqlCommand("Update Staffs set PasscodeTimer='" & saves & "' where Username='" & Loginfrm.BunifuMaterialTextbox1.Text & "'", conn)
